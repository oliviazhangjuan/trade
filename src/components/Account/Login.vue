<template>
  <div class="login-view">
    <h2><a href="javascript:history.go(-1);">取消</a>登录</h2>
    <h1>登录</h1>
    <form method="get" @submit.prevent="submit()">
      ...
      <div class="form-user">
        <label>
          ...
          <input
            ...
            type="text"
            name="username"
            class="border_top_left border_top_right"
            placeholder="用户名">
        </label>
      </div>
      <div class="form-pwd">
        <label>
          ...
          <template v-if="passType === 'password'">
            <input
              ...
              type="password"
              name="password"
              class="border_bottom_left border_bottom_right"
              placeholder="密码">
          </template>
      ...
      <div class="more-login">Tips:任意账号密码即可</div>
      <div class="">
        <button
          class="submit"
          type="submit"
    ...
    <div class="footer">
      ...
      <div class="btns">
        <router-link :to="'/Login'">注册帐号</router-link>
    ...
    methods: {
      ...
      submit: function () {
        ...
        if(!this.credentials.username || !this.credentials.password){
          ...
          $.cookie('UID', this.credentials.username);
          this.$router.push({path: '/Company/homepage'});
        }
      }
    }
  }
